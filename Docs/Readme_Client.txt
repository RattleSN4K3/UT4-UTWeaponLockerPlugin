...
=============================================================================
 ...
 Size: ~ 13.6 - 16,9 MB
 Version: 1.0
 Compatibility: Build 2848065 (2/1/2016)
 Type: C++
 Credits: Epic Games
-----------------------------------------------------------------------------
...
Method 1:
 - Start the game
 - Open the console
 - Enter the following command to open the test map
   open ExampleMapWeaponLocker
 - Enjoy

Method 2:
 - Add the following line to the command line arguments
   (or your shortcut, command line, ...):

   ?map=ExampleMapWeaponLocker
